...
class mail_mail(osv.Model):
    ...
    def send(self, cr, uid, ids, auto_commit=False, raise_exception=False, context=None):
        print '______________nnnnnnnnnnnnneeeeeeeeeeeeeeeeeeeeeeeeeeeeee________________________'
            ...
            try:
                ...
                for email in email_list:
                    if mail.mail_message_id.model == 'crm.helpdesk':
                        ...
                        crm_browse = self.pool.get('crm.helpdesk').browse(cr, uid, mail.mail_message_id.res_id)
                        email_from1 = crm_browse.sent_from
                        
                        if crm_browse.reply_to:
                            reply_to1 = crm_browse.reply_to
                        else:
                            reply_to1 = crm_browse.sent_from
                    else:
